...
final class VideoPlayer {
  ...
  VideoPlayer(
    ...
    MediaItem muxMediaItems = MediaItems.builderFromMuxPlaybackId("6VNYyauzwahtzjQ2jjJ0001U7EVP601DuVtM00Ye01sGFEnw")
    ...
    MuxPlayer muxPlayer = new MuxPlayer.Builder(context)
    ...
    setUpVideoPlayer(muxPlayer, new QueuingEventSink());
  }
